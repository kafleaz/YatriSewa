...
namespace YatriSewa.Controllers
{
    public class ServicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ServiceId,Wifi,AC,BusType,SafetyFeatures,Essentials,Snacks,BusId")] Service service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ServiceId,Wifi,AC,BusType,SafetyFeatures,Essentials,Snacks,BusId")] Service service)
        {
